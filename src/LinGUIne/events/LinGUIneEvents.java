...
public class LinGUIneEvents {
	...
	public static interface Project {
		 ...
		 */
		public static final String PROJECT_BASE_TOPIC = BASE_TOPIC + SEP
				+ "Project";
		 ...
		 */
		public static final String REMOVED = PROJECT_BASE_TOPIC + SEP
				+ "Removed";

		/**
		 * Sent when a Project is modified.
		 */
		public static final String MODIFIED = PROJECT_BASE_TOPIC + SEP
				+ "Modified";
	}
	...
	public static interface UILifeCycle {
		 ...
		 */
		public static final String UI_EVENTS_BASE_TOPIC = BASE_TOPIC + SEP
				+ "UI";

		/**
		 * Used to subscribe to all UI-related events.
		 */
		public static final String ALL_EVENTS = UI_EVENTS_BASE_TOPIC + SEP
				+ ALL;

		/**
		 * Sent when the user attempts to open some ProjectData.
		 */
		public static final String OPEN_PROJECT_DATA = UI_EVENTS_BASE_TOPIC
				+ SEP + "OpenProjectData";

		/**
		 * Sent whenever a visualization has finished running and generates its
		 * view
		 */
		public static final String VISUALIZATION_VIEW = UI_EVENTS_BASE_TOPIC
				+ SEP + "VisualizationView";
	}
}
