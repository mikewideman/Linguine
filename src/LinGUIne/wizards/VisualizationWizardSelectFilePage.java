 ...
 * @author Peter Dimou
 */
public class VisualizationWizardSelectFilePage extends WizardPage {
	 ...
	 */
	public VisualizationWizardSelectFilePage(VisualizationData data,
			ProjectManager projects){
		
		super("Visualization Wizard");
		setTitle("Visualization Wizard - Step 1");
		setDescription("Select the file(s) you wish to visualize.");
...
//					wizardData.setChosenProjectData(new LinkedList<IProjectData>());
	    ...
	    lblFiles.setText("Select the Files on which to run the Visualization:");
